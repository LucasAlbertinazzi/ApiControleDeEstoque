...
namespace API.Models
{
    ...
    {
        public TblNfEntradum()
        {
            TblNfEntradaItems = new HashSet<TblNfEntradaItem>();
        }
        ...
        public virtual TblFornecedore CnpjEmitenteNavigation { get; set; }
        public virtual ICollection<TblNfEntradaItem> TblNfEntradaItems { get; set; }
    }
}
